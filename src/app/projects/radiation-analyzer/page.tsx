  ...
  return (
    <div style={{
      ...
      <div style={{maxWidth: '1200px', margin: '0 auto', padding: '80px 20px'}}>
        ...
        <ImageGallery 
          images={[
            { src: '/projects/radiation-analyzer/pp1.png', alt: 'Radiation Pattern Analysis Interface' },
            { src: '/projects/radiation-analyzer/pp2.png', alt: 'Polar Plot Visualization' },
            { src: '/projects/radiation-analyzer/pp3.png', alt: 'Parameter Control Panel' },
            { src: '/projects/radiation-analyzer/pp4.png', alt: '3D Pattern Visualization' },
            { src: '/projects/radiation-analyzer/pp5.png', alt: 'Data Analysis Results' }
          ]}
